 ...
 */
function sendEmployeeVerificationEmail(string $toEmail, string $firstname, string $verifyLink): array {
...
<div style='max-width: 600px; margin: 0 auto; padding: 20px;'>
    ...
    if ($phpmailer_available) {
        try {
            ...
            return ['success' => false, 'message' => 'Could not send verification email. Please contact support or try again later.'];
        }
    }
