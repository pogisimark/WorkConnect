...
// Eligible: any registered jobseeker (Pending, Referred, Accepted, Rejected, etc.) — e.g. placed workers
// may request admin action (return to pool after resignation, NSRP updates, appeals).
...
if ($result->num_rows === 0) {
    echo json_encode([
        'success' => true,
        'eligible' => false,
        'message' => 'Complete your NSRP registration first. After that, you can send follow-up messages to admin from here.'
    ]);
    exit;
}
