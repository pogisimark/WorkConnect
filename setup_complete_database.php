...
$sql = "CREATE TABLE IF NOT EXISTS jobseeker (
    ...
    placement_active TINYINT(1) NOT NULL DEFAULT 0,
    placement_ended_at DATETIME NULL,
    placement_end_reason VARCHAR(255) NULL,
...
$sql = "CREATE TABLE IF NOT EXISTS job_applications_extended (
    ...
    status ENUM('Applied', 'Viewed', 'Interview', 'Accepted', 'Rejected', 'Withdrawn', 'Closed') DEFAULT 'Applied',
    notes TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
