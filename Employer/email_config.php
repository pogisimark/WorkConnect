<?php
// Email Configuration for WorkConnect
...
define('SMTP_PASSWORD', 'nwpd dzvp mdmt wube'); // Replace with your Gmail App Password
...
// See EMAIL_SETUP_GUIDE.md for instructions on setting up Gmail App Password
?>
